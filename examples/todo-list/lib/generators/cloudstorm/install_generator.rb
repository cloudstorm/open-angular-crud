  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def create_index_base_file
        copy_file 'application_index_base.html.haml',
                  "app/assets/javascripts/templates/#{application_name.underscore}_index_base.html.haml"
      end

      def create_application_js_file
        template 'application.js.coffee.erb',
                 "app/assets/javascripts/applications/#{application_name}.js.coffee"
      end

      def create_resources_file
        template 'resources.js.coffee.erb',
