...
angular.module("components/cs-index/cs-index-sidepanel/cs-index-sidepanel-template.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/cs-index/cs-index-sidepanel/cs-index-sidepanel-template.html",
    ...
    "</div>\n" +
    "<cs-wizard cs-wizard-options='editWizardOptions' ng-if='editWizardOptions' panel-number-callback='panelNumberCallback'></cs-wizard>\n" +
    "");
}]);
...
angular.module("components/cs-wizard/cs-wizard-template.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("components/cs-wizard/cs-wizard-template.html",
    ...
    "        <cs-loader enabled='$ctrl.loading'></cs-loader>\n" +
    "        <div class='form-panel animation' ng-class=\"{'active' : $index==$ctrl.panelStack.length-1,&#x000A;'pre-hover' : panel.hoverOrder &lt; 0,&#x000A;'hover' : panel.hoverOrder==0, 'post-hover' : panel.hoverOrder &gt; 0 }\" ng-if='!$ctrl.loading' ng-init='panelIndex = $index' ng-mouseover='$ctrl.panelHover($index)' ng-repeat='panel in $ctrl.panelStack track by $index'>\n" +
    "          <div autocomplete='off' create-resources='$ctrl.shouldShowNewButton()' cs-form-options='$ctrl.csWizardOptions' cs-form='' form-item='panel.item' form-mode='{{panel.formMode}}' form-parent='panel.parent' form-resource-descriptor='$ctrl.resource_descriptor(panel)' form-resource='panel.resource' ng-class='$ctrl.csWizardOptions[\"form-class\"]' role='form' subform-attribute='panel.attribute' wizard-panel-index='panelIndex'></div>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    "  </div>\n" +
